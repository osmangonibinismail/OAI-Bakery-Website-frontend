...
const blurHeader = () => {
    ...
    // Add a class if the bottom offset is greater than 50 of the viewport height, add the blur-header
...
sr.reveal(`.new__card:nth-child(2) img`, { rotate: { z: 15 }, distance: 0, dela: 600 })
...
sr.reveal(`.favorite__container`, { scale: 1 })
